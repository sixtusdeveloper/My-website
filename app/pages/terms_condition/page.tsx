    ...
    return (
        <main className="bg-secondary p-8">
            <div className="container mx-auto lg:px-10 p-6">
                ...
                <p>
                    I collect various types of information to enhance your experience on my website. This includes:
                </p>
                <ul className="list-disc pl-5 mt-2">
                    <li><strong>Personal Information:</strong> Name, email address, contact information, etc., that you provide to me directly.</li>
                    <li><strong>Usage Data:</strong> Information on how you interact with my website, including IP addresses, browser types, and pages visited.</li>
                    <li><strong>Cookies:</strong> Small data files stored on your device to remember your preferences and improve your browsing experience.</li>
                </ul>
                ...
                <p>
                    I do not sell or rent your personal information. I may share it in the following circumstances:
                </p>
                <ul className="list-disc pl-5 mt-2">
                    <li><strong>Service Providers:</strong> With third-party vendors who assist me in operating my website and services.</li>
                    <li><strong>Legal Requirements:</strong> When required by law or to protect my rights and safety.</li>
                ...
                <ul className="list-disc pl-5 mt-2">
                    ...
                    <li><strong>Deletion:</strong> Request the removal of your personal data, subject to legal obligations.</li>
                    <li><strong>Opt-Out:</strong> Unsubscribe from marketing communications at any time.</li>
                </ul>
                
                <h2 className="text-lg font-bold mt-4">Security</h2>
                <p>
                    I implement appropriate technical and organizational measures to protect your personal information from unauthorized access, disclosure, or destruction.
                </p>
                ...
                <div className="flex items-center gap-4 py-4">
                    <p className="text-sm text-gray-600 mt-8">You may as well read the Privacy Policy of this application <a href="https://www.sixtusdev.net/pages/privacy_policy" className="text-blue-600 hover:underline">Privacy Policy</a></p>
