...
export const experiences = [
  ...
  },  
  {
    ...
    description: "Assisting in developing enterprise ready software solutions for clients across various industries",
    fullDesc: "Assisting in developing enterprise-ready software solutions for clients across various industries, including e-commerce, healthcare, and education. Collaborating with cross-functional teams to deliver high-quality products and services, leveraging agile methodologies and best practices. Conducting code reviews, implementing automated testing, and optimized application performance to ensure scalability and reliability. Contributing to the design and architecture of web applications, APIs, and databases, utilizing modern technologies such as React, Next.js, Node.js, MongoDB, Clerk, Appwrite and TypeScript.",
...
export const education = [
  {
    ...
    status: "Graduated - Graduated - Certified",
