...
export const experiences = [
  ...
  },  
  {
  ...
  
    {
      ...
      description:
        "Provided top-tier customer support by handling inquiries, complaints, and payment transactions, ensuring seamless service delivery.",
      fullDesc:
        "Managed customer interactions, resolved complaints, and processed payments efficiently while adhering to company policies. Assisted customers with orders, refunds, and stock availability while leveraging CRM tools to track interactions and improve service operations.",
      technologies: [
        "POS Systems",
        "Vendhq",
        "Microsoft Excel",
    ...
    },
    {
      ...
      location: "Lagos, Nigeria",
      description:
        "Supervised daily store operations, ensuring smooth workflow, optimal inventory management, and excellent customer experiences.",
      fullDesc:
        "Led and trained frontline staff to enhance service efficiency and customer engagement. Monitored transactions, reconciled sales reports, and enforced company policies. Resolved escalated customer complaints, improved stock control, and implemented workflow optimizations that enhanced sales performance.",
      technologies: [
        "POS Systems",
        "Vendhq",
        "Microsoft Excel",
