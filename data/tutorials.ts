...
export const tutorials: Tutorial[] = [
    ...
    },
    {
      ...
      description: "In this video, I provide an introduction to JavaScript. I cover the basics of the language, including variables, data types, functions, and control flow. I also discuss how JavaScript is used in web development.",
    },
    {
      title: "React Basics for Beginners",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
      description: "In this video, I cover the basics of React for beginners. I discuss what React is, how it works, and how to get started building applications with it. I also provide tips and resources for learning more about React.",
    },
    {
      title: "Building simple websites with HTML & CSS",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
      description: "In this video, I show you how to build simple websites using HTML and CSS. I cover the basics of both languages, including how to create a basic webpage layout, style it with CSS, and add interactivity with JavaScript.",
    },
  ];
