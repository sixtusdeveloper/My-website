  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div
            ...
            onClick={onClose}
        />
        <div className="relative bg-secondary my-8 border shadow-lg rounded-lg max-w-3xl w-full p-6">
            <button
                onClick={onClose}
                className="absolute top-2 z-40 right-2 p-2 cursor-pointer rounded-full bg-secondary"
                >
                <IoClose size={18} />
            </button>
            <div className="px-8 max-h-[80vh] overflow-auto no-scrollbar">
                ...
                <p className="text-center text-base px-8 my-4 tracking-wide leading-6">
