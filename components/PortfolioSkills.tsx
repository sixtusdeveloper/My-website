  ...
  return (
    ...
    <section id="skills" className="bg-secondary relative md:pt-10 px-6 lg:px-8 pb-20">
      <div className="mx-auto max-w-5xl relative">
        <h2 className="py-10 font-bold text-center text-[2rem] lg:text-[2.5rem] leading-snug tracking-wide"><strong>My Current <span className='bg-gradient-to-r from-purple-800 via-blue-500 to-indigo-800 bg-clip-text text-transparent'>Skills & Tools</span></strong></h2>
