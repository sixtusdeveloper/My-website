...
export default function CallToAction() {
  ...
  return (
    <>
      <div
        id="e-books"
        className="flex flex-col sm:flex-row p-2 md:p-6 border justify-center items-center bg-gradient-to-r from-yellow-800 via-green-800 to-purple-800 shadow-lg"
      >
