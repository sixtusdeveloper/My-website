          ...
          {currentProjects.map(({ id, title, des, img, githubLink, iconLists, link }) => (
            ...
            >
              ...
              <div className="p-4 my-1">
                ...
                <div className="inline-flex w-full gap-2 relative rounded-full border px-2 py-1 text-sm bg-transparent">
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="relative flex">
                    {iconLists.map((icon, index) => (
                      <div
                        key={index}
                        className="border rounded-full bg-gray-400 w-8 h-8 flex justify-center items-center"
                        style={{
