    ...
    <div className="relative bg-secondary w-full mx-auto md:pt-8 px-4 lg:px-8 pb-10" id="projects">
      <div className="mx-auto max-w-6xl relative">
        ...
        <h1 className="font-bold text-center text-[2rem] lg:text-[2.5rem] leading-snug tracking-wide">
          <strong>My&nbsp;<span className="bg-gradient-to-r from-purple-800 via-blue-500 to-purple-600 bg-clip-text text-transparent">Recent Projects</span></strong>
        </h1>
        ...
        <div className="flex justify-center my-4">
          <button
            ...
            className={`px-4 py-2 mx-2 text-xs md:text-base rounded-md tracking-wide cursor-pointer transition-all duration-300 ${
          ...
          <button
            ...
            className={`px-4 py-2 text-xs md:text-base mx-2 rounded-md tracking-wide transition-all duration-300 ${
