...
//   const [intervalId, setIntervalId] = useState<NodeJS.Timeout | null>(null); // Stores interval ID

//   // Function to start background transition
...
//           );
//           setFade(true); // Start fade-in effect
//         }, 2000); // Wait 2 seconds before changing image
//       }
...
//   // Function to stop background transition
//   const stopBackgroundTransition = () => {
//     if (intervalId) {
...
//   // Effect to control background transition and fading
//   useEffect(() => {
//     if (!isHeroModalOpen && !isBlogModalOpen) {
//       startBackgroundTransition();
//     } else {
//       stopBackgroundTransition();
//       setFade(true); // Keep background stable when modal is open
//     }

//     return () => stopBackgroundTransition();
//   }, [isHeroModalOpen, isBlogModalOpen]);
...
//       style={{
//         backgroundImage: `url(${backgroundImages[backgroundIndex]})`,
//         opacity: !isHeroModalOpen && !isBlogModalOpen ? (fade ? 1 : 0.3) : 1, // Prevent opacity changes when modal is open
//         transition:
//           !isHeroModalOpen && !isBlogModalOpen
//             ? "opacity 3s ease-in-out"
//             : "none", // Disable opacity transition when modal is active
//       }}
//     >
//       <div className="absolute inset-0 bg-black bg-opacity-70"></div>
