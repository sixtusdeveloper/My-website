...
const Home = () => {
  ...
  return (
    <section id="portfolio" className="relative py-10 flex items-center justify-center h-screen bg-secondary">
      <div className="relative z-10 p-8 mt-20 max-w-2xl text-center">
