  ...
  return (
    <section id="projects" className="py-10 px-4 lg:px-8 bg-secondary">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-bold text-center text-[2rem] lg:text-[2.5rem] leading-snug tracking-wide mb-8"><strong>Some of my <span className="bg-gradient-to-r from-purple-800 via-blue-500 to-indigo-600 bg-clip-text text-transparent">Personal Projects</span></strong></h2>
        <div className="grid gap-4 md:gap-6 lg:gap-8 md:grid-cols-2">
          ...
          <div className="flex relative justify-center gap-4 p-4 bg-secondary border rounded-[1.75rem]">
            ...
            <div>
              ...
              <p className="py-4 leading-6 mb-0 text-base">
