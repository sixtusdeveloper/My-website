            ...
            {feedback === "yes" ? (
              <>
                ...
                <p className="text-sm mt-4">
                  ...
                  using the Contact link below or chat with me live and direct
                  by clicking the WhatsApp or email link within the contact
                  section of this page or at the bottom of my portfolio page.
                </p>
                <button
                  onClick={handleChatDirectly}
                  className="h-12 py-3 px-6 items-center w-full mt-4 bg-gradient-to-r from-indigo-600 via-blue-500 to-purple-600 text-white rounded-lg"
                >
                  Chat me directly
                </button>
              </>
              ...
              <>
                ...
                <p className="text-sm mt-4">
                  ...
                  out using the Contact link below or chat with me live and
                  direct using the WhatsApp or email link within the contact
                  section of this page or at the bottom of my portfolio page.
                </p>
                <button
                  onClick={handleChatDirectly}
                  className="h-12 py-3 px-6 items-center w-full mt-4 bg-gradient-to-r from-indigo-500 via-blue-500 to-purple-600 text-white rounded-lg"
                >
                  Reach out to me
                </button>
              </>
...
//                 </p>
//                 <a href="#contact">
//                   <button className="h-12 py-3 px-6 items-center w-full mt-4 bg-gradient-to-r from-indigo-600 via-blue-500 to-purple-600 text-white rounded-lg">
//                     Chat me directly
//                   </button>
//                 </a>
//               </>
...
//                 </p>
//                 <a href="#contact">
//                   <button className="h-12 py-3 px-6 items-center w-full mt-4 bg-gradient-to-r from-indigo-500 via-blue-500 to-purple-600 text-white rounded-lg">
//                     React out to me
//                   </button>
//                 </a>
//               </>
