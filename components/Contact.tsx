  ...
  return (
    <section id="contact" className="py-20 px-4 lg:px-8 bg-secondary">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="font-bold text-center text-[2rem] lg:text-[2.5rem] leading-snug tracking-wide mb-8"><strong>Let’s <span className='bg-gradient-to-r from-purple-800 via-blue-500 to-indigo-800 bg-clip-text text-transparent'>Connect</span></strong></h2>
