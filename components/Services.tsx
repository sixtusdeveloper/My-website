...
import Modal from "@/components/NewServicesModal";
...
const Courses = () => {
  ...
  const paginatedCourses = Services.slice(
  ...
  return (
    <section id="services" className="py-12 lg:py-20 bg-secondary relative">
      <div className="max-w-6xl mx-auto md:px-4 px-4 text-left md:text-center">
        {/* Section Header */}
          ...
          {paginatedCourses.map((course) => (
            ...
            >
              ...
              <div className="px-4 py-6 text-left">
                <h3 className="text-gray-700 dark:text-blue-50 text-[18px] font-semibold mb-2">
                  {course.title}
                </h3>
                ...
                <button
                  ...
                  className="mt-4 py-2 px-6 items-center rounded-md text-white text-sm md:text-[14px] font-semibold bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500 block hover:ease-in-out hover:scale-105 transition-all duration-300"
                >
                  Learn More
                </button>
              </div>
        ...
        <div className="flex justify-center items-center mt-10 space-x-4">
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold rounded transition-all duration-300 flex items-center ${
              currentPage === 1
                ? "bg-gray-300 dark:bg-gray-800 text-gray-500 cursor-not-allowed"
                : "bg-gradient-to-r from-purple-500 via-purple-800 to-pink-500 text-white hover:scale-105"
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold rounded transition-all duration-300 flex items-center ${
              currentPage === totalPages
                ? "bg-gray-300 dark:bg-gray-800 text-gray-500 cursor-not-allowed"
                : "bg-gradient-to-r from-yellow-500 via-pink-500 to-purple-600 text-white hover:scale-105"
            }`}
          >
...
//             <button
//               type="button"
//               className="ring-1 ring-blue-500 hover:ring-0 text-blue-500 hover:dark:text-white dark:text-blue-300 hover:bg-gradient-to-r hover:from-blue-500 hover:via-purple-500 hover:to-green-600 hover:bg-blue-600 hover:text-white text-sm md:text-base font-semibold h-12 px-6 py-3 rounded-md hover:ease-in-out hover:scale-105 transition-all duration-300"
//             >
