...
const PrivacyPolicySection = () => {
  ...
  return (
    <div className="bg-secondary mx-auto py-10 lg:py-10 lg:px-20 px-4">
      ...
      <h2 className="py-2 text-gray-700 dark:text-blue-50 lg:text-xl text-lg font-bold mt-4">
      ...
      <ul className="list-disc pl-5 mt-2 text-gray-600 dark:text-blue-100 text-base">
